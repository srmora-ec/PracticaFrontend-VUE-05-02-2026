...
<template>
    <div
        class="p-1 w-full bg-[#0c1014] group border-t border-[#43474b]">
        <ul class="flex justify-around">
            <a href="#">
                <li class="text-white flex items-center cursor-pointer p-3 rounded-2xl hover:bg-[#25282c]">
             ...
             <a href="#">
                <li class="text-white flex gap-3 items-center cursor-pointer p-3 rounded-2xl hover:bg-[#25282c]">
            ...
            <a href="#">
                <li class="text-white flexitems-center cursor-pointer p-3 rounded-2xl hover:bg-[#25282c]">
                    <img src="https://media.licdn.com/dms/image/v2/D4E35AQFMLOlYS9PgPw/profile-framedphoto-shrink_200_200/B4EZtt_2k1IwAc-/0/1767077014073?e=1770951600&v=beta&t=JKYBjXQjL7vYjNqrdOsFLCGb5Ire8FM5qSrFjGSUe8E"
                        class="w-5.5 h-5.5 rounded-full border-2 border-white" />
                </li>
            </a>
